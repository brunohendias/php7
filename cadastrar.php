...
<body>
	<nav class="navbar navbar-dark bg-dark">
		...
		<ul class="nav">
			<li class="nav-item">
				<?php session_start();if(isset($_SESSION['user'])):echo "<li style='width: 35px;height: 35px;background-color: white;border-radius: 20px;'></li> "."<span class='nav-link' style='color: white;'>".$_SESSION['user']."</span>";endif; ?>
			</li>
		</ul>
	</nav>
